...
try {
	...
	//error_log("result = ".$_GET['result'], 3, "error.txt");

	if (
		isset($_GET['result']) && isset($_GET['timestamp']) && isset($_GET['type'])
		...
		error_log("results type = " . $type, 3, "error.txt");
		...
		error_log("score = ".$_SESSION["score"], 3, "error.txt");
